...
public class practice02 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		String brandName="로지텍";		//	String
		String itemTeg="mx keys";		//	String
		int item=135000;				//	int
		String number="332L1545K";		//	String
		...
		*/
		...
		String officeName="SAMSUSG";	//  String
		int moniterInch=24;				//  int
		String moniterColor= "black";	//  String
		boolean hdmiPort=true;			//  boolean
		boolean speakerOutput=false;	//  boolean
		...
		*/
		...
		System.out.println(Double.parseDouble(mathScore)+Double.parseDouble(englishScore)+Double.parseDouble(artScore));
